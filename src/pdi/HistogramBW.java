...
public class HistogramBW {
    ...
    private ChartPanel createChartPanel() {
        ...
        // chart
        JFreeChart chart = ChartFactory.createHistogram("Histograma B&W", "Valor",
            "Contagem", dataset, PlotOrientation.VERTICAL, true, true, false);
    ...
    private void display() {
        JFrame f = new JFrame("Histograma B&W");
