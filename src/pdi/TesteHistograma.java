...
import javax.swing.*;
    ...
    public class TesteHistograma extends JPanel {

   int[] bins = new int[256];
  TesteHistograma(int[] pbins) {
    bins = pbins;
    repaint();
   }
 ...
 protected void paintComponent(Graphics g) {
  ...
  public static void main(String[] args) throws IOException {
    ...
    PlanarImage image = JAI.create("fileload", "imagens/circuit.jpg");
    ...
    for (int x = 0; x < bi.getWidth(); x++) {
     ...
     ImageIcon im= new ImageIcon(bi);
      //jtp.add("New image", new JLabel((im)));
        jtp.addTab("Histogram",new TesteHistograma(sbins));
        frame.add(jtp);
